...
CREATE TABLE rulesets (
    ...
    description TEXT NULL,
    tags_json TEXT NOT NULL DEFAULT '[]',
    promotion_provenance_json TEXT NULL,
...
CREATE TABLE memory_records (
    ...
    body_markdown_projection TEXT NOT NULL,
    summary_text TEXT NULL,
    metadata_json TEXT NOT NULL DEFAULT '{}',
    retention_class TEXT NOT NULL CHECK (retention_class IN ('ephemeral', 'task', 'workspace', 'profile', 'pinned')),
    retention_expires_at TEXT NULL,
    retention_pinned_at TEXT NULL,
    retention_supersedence_rationale TEXT NULL,
