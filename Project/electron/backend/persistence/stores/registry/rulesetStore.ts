...
function parsePromotionProvenance(value: string | null): RulesetDefinitionRecord['promotionProvenance'] {
    if (!value) {
        return undefined;
    }
    ...
    return Object.keys(parsed).length > 0
        ? (parsed as unknown as RulesetDefinitionRecord['promotionProvenance'])
        : undefined;
}
