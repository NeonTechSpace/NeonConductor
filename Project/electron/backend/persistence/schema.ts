...
import type {
    SessionDevBrowserCommentDraftsTable,
    SessionDevBrowserDesignerDraftsTable,
    SessionDevBrowserSelectionsTable,
    SessionDevBrowserStateTable,
} from '@/app/backend/persistence/schemaTables/sessionDevBrowserTables';
import type {
