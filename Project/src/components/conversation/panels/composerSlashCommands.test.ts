...
function createSkill(input: {
    ...
    return {
        ...
        profileId: 'prof_1',
        source: input.scope,
        targetKind: 'shared' as const,
        relativeRootPath: `skills/shared/${input.assetKey.replace(/^skills\//u, '')}/SKILL.md`,
        bodyMarkdown: '',
...
function createManualRule(input: {
    ...
    return {
        ...
        source: input.scope,
        targetKind: 'shared' as const,
        relativeRootPath: `rules/shared/${input.assetKey.replace(/^rules\//u, '')}.md`,
        bodyMarkdown: '',
