...
const controllerTestState = vi.hoisted(() => {
    const surfaceState = {
        ...
        queries: {
            ...
            kiloCloudSessionPrerequisites: undefined,
            ...
            kiloCloudSessionPrerequisitesQuery: { isLoading: false },
        ...
        mutations: {
            ...
            refreshAccountContextMutation: { isPending: false },
        ...
        actions: {
            ...
            refreshKiloAccountContext: vi.fn().mockResolvedValue(undefined),
        },
